// Asychronous Code in JavaScript Exercise 
...
// 2.   Why isn't the data showing up on the page?
let favNums = [4,5,9]
$.getJSON(`${baseURL1}/${favNums}?json`)
    .then(data => console.log(data))
    .then(data => $("#part1-2").append(data)); // if I append data.text, I get an error
